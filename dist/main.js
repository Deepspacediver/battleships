...
var gameHandler = function gameHandler(playerName) {
  ...
  var isOutOfBounds = function isOutOfBounds(coordinate, shipLength) {
    return coordinate[1] + shipLength > 10;
  };
  ...
  var anchorAShip = function anchorAShip(chosenCoordinate, shipData) {
    ...
    var shipPlacement = generatePlacement(chosenCoordinate, shipData.length);
...
/* harmony import */ var _gameHelpers_placement_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../gameHelpers/placement-helpers */ "./src/gameHelpers/placement-helpers.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var Gameboard = function Gameboard() {
  ...
  var placeShip = function placeShip(length, name, coordinates) {
    ...
    generateIllegalMoves(coordinates, _gameHelpers_placement_helpers__WEBPACK_IMPORTED_MODULE_2__.illegalVariants, unavailableCoords);
  };
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "main{\n  width: 850px;\n  height: 400px;\n  margin: 0 auto;\n  display: block;\n  display: flex;\n}\n#display { \n  width: 400px;\n  height: 100px;\n  margin: 0 auto;\n}\n#player-board, #ai-board, #place-ship-board{\n  width: 400px;\n  height: 400px;\n  border: 1px solid black;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n}\n\n.square {\n  border: 1px solid black;\n}\n.active > div:hover {\n  background-color: purple;\n  cursor: pointer;\n}\n.missed {\n  background-color: grey;\n}\n\n.hit{\n  background-color: red;\n}\n\n.anchored {\n  background-color: green !important; \n}\n.dragover{\n  background-color: purple;\n}\n.removed{\n  opacity: 0.2;\n}\n.outOfBounds{\n  background-color: gray;\n}\n#board-creator {\n  display: grid;\n  width: 80vw;\n  grid-template-columns: 1fr 1fr;\n}\n\n#ships-container {\n  display: grid;\n}\n.ship {\n  display: grid;\n  grid-auto-flow: column;\n  max-height: 40px;\n  max-width: fit-content;\n\n}\n.block{\n  border: 1px solid black;\n  width: 40px;\n}\n.hidden{\n  display: none;\n}\n\n#place-ship-board .square:-moz-drag-over {\n  background-color: purple;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,aAAa;EACb,cAAc;EACd,cAAc;EACd,aAAa;AACf;AACA;EACE,YAAY;EACZ,aAAa;EACb,cAAc;AAChB;AACA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,aAAa;EACb,sCAAsC;AACxC;;AAEA;EACE,uBAAuB;AACzB;AACA;EACE,wBAAwB;EACxB,eAAe;AACjB;AACA;EACE,sBAAsB;AACxB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,kCAAkC;AACpC;AACA;EACE,wBAAwB;AAC1B;AACA;EACE,YAAY;AACd;AACA;EACE,sBAAsB;AACxB;AACA;EACE,aAAa;EACb,WAAW;EACX,8BAA8B;AAChC;;AAEA;EACE,aAAa;AACf;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,gBAAgB;EAChB,sBAAsB;;AAExB;AACA;EACE,uBAAuB;EACvB,WAAW;AACb;AACA;EACE,aAAa;AACf;;AAEA;EACE,wBAAwB;AAC1B","sourcesContent":["main{\n  width: 850px;\n  height: 400px;\n  margin: 0 auto;\n  display: block;\n  display: flex;\n}\n#display { \n  width: 400px;\n  height: 100px;\n  margin: 0 auto;\n}\n#player-board, #ai-board, #place-ship-board{\n  width: 400px;\n  height: 400px;\n  border: 1px solid black;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n}\n\n.square {\n  border: 1px solid black;\n}\n.active > div:hover {\n  background-color: purple;\n  cursor: pointer;\n}\n.missed {\n  background-color: grey;\n}\n\n.hit{\n  background-color: red;\n}\n\n.anchored {\n  background-color: green !important; \n}\n.dragover{\n  background-color: purple;\n}\n.removed{\n  opacity: 0.2;\n}\n.outOfBounds{\n  background-color: gray;\n}\n#board-creator {\n  display: grid;\n  width: 80vw;\n  grid-template-columns: 1fr 1fr;\n}\n\n#ships-container {\n  display: grid;\n}\n.ship {\n  display: grid;\n  grid-auto-flow: column;\n  max-height: 40px;\n  max-width: fit-content;\n\n}\n.block{\n  border: 1px solid black;\n  width: 40px;\n}\n.hidden{\n  display: none;\n}\n\n#place-ship-board .square:-moz-drag-over {\n  background-color: purple;\n}"],"sourceRoot":""}]);
// Exports
