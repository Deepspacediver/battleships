...
var Gameboard = function Gameboard() {
  ...
  var receiveAttack = function receiveAttack(coordinate) {
    ...
    if (indexOfShip !== undefined) shipList[indexOfShip].ship.hit();else missedShots.add(String(coordinate));
  };
