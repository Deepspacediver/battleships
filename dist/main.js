...
var createBoards = function createBoards(coordinates) {
  coordinates.forEach(function (coordinate) {
    ...
    var squareClone = square.cloneNode();
...
var gameHandler = function gameHandler(playerName) {
  ...
  var intializeAttack = function intializeAttack() {
    AIBoardDOM.addEventListener("click", function (e) {
  ...
  var isGameOver = function isGameOver(turn) {
    return turn === "realPlayer" ? players.AI.board.areAllSunk() : players.realPlayer.board.areAllSunk();
  };
  var endGame = function endGame() {
    // Implement modal to pop up instead of alter
    if (isGameOver(getTurn())) alert("".concat(getTurn(), " has won!"));
  };
  return {
    getTurn: getTurn,
    playerTurn: playerTurn,
    changeTurn: changeTurn,
    intializeAttack: intializeAttack,
    players: players
  };
};
var myGameHandler = gameHandler();
myGameHandler.players.AI.board.placeShip(2, "destroyer", [[1, 2], [1, 3]]);
myGameHandler.players.AI.board.placeShip(3, "submarine", [[3, 2], [3, 3], [3, 4]]);
myGameHandler.players.AI.board.placeShip(4, "battleship", [[5, 2], [5, 3], [5, 4], [5, 5]]);
myGameHandler.players.realPlayer.board.placeShip(2, "destroyer", [[2, 2], [2, 3]]);
myGameHandler.players.realPlayer.board.placeShip(3, "submarine", [[4, 2], [4, 3], [4, 4]]);
myGameHandler.players.realPlayer.board.placeShip(4, "battleship", [[6, 2], [6, 3], [6, 4], [6, 5]]);
myGameHandler.intializeAttack();
playerBoardDOM.addEventListener("click", function () {
...
/* harmony import */ var _battleship_factory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./battleship-factory */ "./src/modules/battleship-factory.js");
...
var Gameboard = function Gameboard() {
  ...
  var placeShip = function placeShip(length, name, coordinates) {
    var shipObject = {
      ship: (0,_battleship_factory__WEBPACK_IMPORTED_MODULE_1__["default"])(length, name),
      coordinates: coordinates
    };
    shipList.push(shipObject);
  };
  var receiveAttack = function receiveAttack(coordinate) {
    var indexOfShip = seeIfOnBoard(coordinate);
  ...
  var seeIfOnBoard = function seeIfOnBoard(coordinate) {
    var index = 0;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "main{\n  width: 850px;\n  height: 400px;\n  margin: 0 auto;\n  display: block;\n  display: flex;\n}\n#display { \n  width: 400px;\n  height: 100px;\n  margin: 0 auto;\n}\n#player-board, #ai-board{\n  width: 400px;\n  height: 400px;\n  border: 1px solid black;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n}\n\n.square {\n  border: 1px solid black;\n}\n\n.missed {\n  background-color: grey;\n}\n\n.hit{\n  background-color: red;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,aAAa;EACb,cAAc;EACd,cAAc;EACd,aAAa;AACf;AACA;EACE,YAAY;EACZ,aAAa;EACb,cAAc;AAChB;AACA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,aAAa;EACb,sCAAsC;AACxC;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,qBAAqB;AACvB","sourcesContent":["main{\n  width: 850px;\n  height: 400px;\n  margin: 0 auto;\n  display: block;\n  display: flex;\n}\n#display { \n  width: 400px;\n  height: 100px;\n  margin: 0 auto;\n}\n#player-board, #ai-board{\n  width: 400px;\n  height: 400px;\n  border: 1px solid black;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n}\n\n.square {\n  border: 1px solid black;\n}\n\n.missed {\n  background-color: grey;\n}\n\n.hit{\n  background-color: red;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_gameHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/gameHandler */ "./src/modules/gameHandler.js");
/* harmony import */ var _modules_battleship_factory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/battleship-factory */ "./src/modules/battleship-factory.js");
