...
var canEndGame = function canEndGame() {
  ...
  if (myGameHandler.isGameOver()) {
    if (myGameHandler.players.AI.board.areAllSunk()) gameoverResult.textContent = "You have won";else gameoverResult.textContent = "AI has won won";
