...
var gameHandler = function gameHandler(playerName) {
  ...
  var isInIllegalCoords = function isInIllegalCoords(shipPlacement, illegalMoves) {
  ...
  var anchorAShip = function anchorAShip(chosenCoordinate, shipData) {
    ...
    if (isShipPlaced(shipData.name, playerBoard.shipList) || isInIllegalCoords(shipPlacement, playerBoard.unavailableCoords)) return;
...
var Gameboard = function Gameboard() {
  ...
  var generateIllegalMoves = function generateIllegalMoves(coordinates, illegalPossibilites, illegalSet) {
  ...
  var allCoordinates = _toConsumableArray(_gameHelpers_AI_possible_attacks__WEBPACK_IMPORTED_MODULE_1__.myNew2D);
  var getRandomIndex = function getRandomIndex(indexArray) {
    return indexArray.splice(Math.floor(Math.random() * indexArray.length), 1);
  };
  var getRandomShip = function getRandomShip(shipCollectionHelper) {
