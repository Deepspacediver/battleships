...
;// CONCATENATED MODULE: ./src/gameHelpers/AI-possible-attacks.js
...
/* harmony default export */ const AI_possible_attacks = (possibleAttacks);

;// CONCATENATED MODULE: ./src/DOM/createBoardDOM.js
...
createBoards(AI_possible_attacks);
// EXTERNAL MODULE: ./src/DOM/dragDropShips.js
var dragDropShips = __webpack_require__(183);
// EXTERNAL MODULE: ./node_modules/lodash.isequal/index.js
var lodash_isequal = __webpack_require__(307);
var lodash_isequal_default = /*#__PURE__*/__webpack_require__.n(lodash_isequal);
;// CONCATENATED MODULE: ./src/modules/battleship-factory.js
...
/* harmony default export */ const battleship_factory = (Ship);
;// CONCATENATED MODULE: ./src/gameHelpers/placement-helpers.js
...
var Gameboard = function Gameboard() {
  var board = _toConsumableArray(AI_possible_attacks);
  var shipList = [];
  var missedShots = new Set();
  var unavailableCoords = new Set();
  var isInAnArray = function isInAnArray(array, element) {
    return array.some(function (el) {
      return lodash_isequal_default()(el, element);
    });
  };
  var generateIllegalMoves = function generateIllegalMoves(coordinates) {
    var illegalPossibilites = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : illegalVariants;
  ...
  var placeShip = function placeShip(length, name, coordinates) {
    var shipObject = {
      ship: battleship_factory(length, name),
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (object.coordinates.some(function (x) {
          return lodash_isequal_default()(coordinate, x);
        })) return index;
        index += 1;
      }
    } catch (err) {
  ...
  var randomlyPlaceShips = function randomlyPlaceShips() {
    ...
    while (indexArray.length) {
      ...
      var shipHelper = shipArray[randomIndex];
...
;// CONCATENATED MODULE: ./src/modules/player-factory.js
...
/* harmony default export */ const player_factory = (Player);
;// CONCATENATED MODULE: ./src/modules/gameHandler.js
function gameHandler_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = gameHandler_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function gameHandler_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return gameHandler_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return gameHandler_arrayLikeToArray(o, minLen); }
function gameHandler_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var gameHandler = function gameHandler(playerName) {
  ...
  var players = {
    realPlayer: player_factory(playerName),
    AI: player_factory("AI")
  };
  ...
  var isShipPlaced = function isShipPlaced(name, shipList) {
    // eslint-disable-next-line no-restricted-syntax
    var _iterator = gameHandler_createForOfIteratorHelper(shipList),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
  ...
  // Game loop
  var AIPossibleAttacks = AI_possible_attacks;
  ...
  var AIMove = function AIMove() {
    ...
    var currentTurn = getTurn();
    var AITarget = getValidAttack(AIPossibleAttacks);
...
/* harmony default export */ const modules_gameHandler = (gameHandler);
;// CONCATENATED MODULE: ./src/DOM/DOMEvents.js

var DOMEvents_AIBoard = document.getElementById("ai-board");
var DOMEvents_playerBoard = document.getElementById("player-board");
var DOMEvents_boardForPlacement = document.getElementById("place-ship-board");
...
var myGameHandler = modules_gameHandler("test");
var renderPlayerShips = function renderPlayerShips() {
  ...
  playerShips.forEach(function (shipObj) {
    shipObj.coordinates.forEach(function (coord) {
      var coordOnPlayerBoard = DOMEvents_playerBoard.querySelector("[data-x=\"".concat(coord[0], "\"][data-y=\"").concat(coord[1], "\"]"));
...
var attackingPhase = function attackingPhase() {
  ...
  DOMEvents_AIBoard.classList.add("active");
  renderPlayerShips();
  myGameHandler.players.AI.board.randomlyPlaceShips();
  DOMEvents_AIBoard.addEventListener("mousedown", function (e) {
...
DOMEvents_boardForPlacement.addEventListener("dragover", function (e) {
  if (e.target.id === "place-ship-board" || e.target.classList.contains("anchored")) return;
  e.target.classList.add("dragover");
  e.preventDefault();
});
DOMEvents_boardForPlacement.addEventListener("dragleave", function (e) {
...
var addAnchoredClass = function addAnchoredClass(shipPlacement) {
  shipPlacement.forEach(function (placement) {
    var placementInDOM = DOMEvents_boardForPlacement.querySelector("[data-x=\"".concat(placement[0], "\"][data-y=\"").concat(placement[1], "\"]"));
    placementInDOM.classList.add("anchored");
  });
};
DOMEvents_boardForPlacement.addEventListener("drop", function (e) {
  e.target.classList.remove("dragover");
  var objectData = {
...
var resetBoard = function resetBoard() {
  myGameHandler = modules_gameHandler("test");
